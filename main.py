...
# mainmenu.add_command(label="Save As", command=save_as)
...
#icon
image_icon = PhotoImage(file="logo.png")  #TODO
root.iconphoto(False, image_icon)

color_box = PhotoImage("color section.png")  #TODO
Label(root, image=color_box, bg="#f2f3f5").place(x=10, y=20)

eraser=PhotoImage(file="eraser.png")  #TODO
...
canvas = Canvas(root, width=930, height=500, background="white", cursor="crosshair")
...
slider = ttk.Scale(root, from_=0, to=30, orient='horizontal', command=slider_changed, variable=current_value)
slider.place(x=50, y= 530)

#value label
value_label = ttk.Label(root, text=get_current_value(), background='#8B8B83')
value_label.place(x=10, y=534)
